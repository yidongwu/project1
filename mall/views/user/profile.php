                    ...
                    <div class="col-xs-12 col-sm-3 center">
                        <div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="assets/profile-pic.jpg" />
												</span>
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="center">
												<span class="btn btn-app btn-sm btn-light no-hover">
													<span class="line-height-1 bigger-170 blue"> <?php echo $views_count; ?> </span>

													<br />
													<span class="line-height-1 smaller-90"> 看过的商品 </span>
												</span>

												<span class="btn btn-app btn-sm btn-yellow no-hover">
													<span class="line-height-1 bigger-170"> <?php echo $views_most['data']; ?> </span>

													<br />
													<span class="line-height-1 smaller-90"> 看过最多 </span>
												</span>

												<span class="btn btn-app btn-sm btn-pink no-hover">
													<span class="line-height-1 bigger-170"> <?php echo $recommend_goods['data'] ?> </span>

													<br />
													<span class="line-height-1 smaller-90"> 推荐商品 </span>
												</span>
                                                ...
                                                <span class="btn btn-app btn-sm btn-success no-hover">
													...
													<br />
													<span class="line-height-1 smaller-90"> 优惠券 </span>
												</span>
                        </div>
                        ...
                        <div class="profile-user-info profile-user-info-striped">
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="NickName"><?php echo $user_info['nick_name'] ?></span>
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    ...
                                    <span class="editable" id="country"><?php echo $user_info['address'] ?></span>
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="signup"><?php echo date("Y-m-d H:i:s", $user_info['createTime']); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <span class="editable" id="login"><?php echo date("Y-m-d H:i:s", $user_info['login_time']); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main padding-8">
                                    <div id="profile-feed-1" class="profile-feed">
                                        ...
                                        <?php
                                            foreach($shop_info['data'] as $shop_item) {
                                                $addtime = date("Y-m-d", $shop_item['addtime']);
                                                $url_goods = Html::a($shop_item['goods_name'], ['home/detail', 'id' => $shop_item['goods_id']]);
                                                $div_item = <<<ITEM
                                        <div class="profile-activity clearfix">
                                            <div>
                                                <img class="pull-left" alt="Susan Smith's avatar" src="https://img14.360buyimg.com/n7/jfs/t24490/225/1613521471/279579/866ca48c/5b63f12fNdc088210.jpg" />
                                                <a class="user" href="#"> {$url_goods} </a>
                                                <div class="time">
