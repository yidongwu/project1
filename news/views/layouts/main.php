...
$menu_list = $this->params['menu_list'];
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
<!DOCTYPE html>
...
<body>
<!--此處引入layout目錄下的banner.html文件，通過php的include--[start]-->
...
<!--此處引入layout目錄下的banner.html文件，通過php的include--[end]-->
...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <!--側邊欄導入layout/slider.html,通過php--[start]-->
            ...
            <ul class="nav nav-list">
                ...
                foreach($menu_list as $menu_item) {
                    if(0 == $menu_item['parent_id']) {
                        ?>
                        <li class=""> <!--class=active 会自动打开二级菜单-->
                            ...
                            <?php
                                if(!empty($menu_item['sub_menu'])) {
                                    foreach($menu_item['sub_menu'] as $sub_menu_item) {
                                        ?>
                                        <li>
                                            <a href="<?=Url::to([$sub_menu_item['url']]) ?>">
                                                <i class="icon-leaf"></i>
                                                <?= $sub_menu_item['name']?>
                                            </a>
                                        </li>
        ...
        <!--側邊欄導入layout/slider.html,通過php--[end]-->

        <div class="main-content">
            <!--麵包屑--[start]--將這部分替換為yii2的麵包屑-->
